...
public class AnimalControllerTest extends ControllerTest {
    ...
    public void getAnimalTest() throws Exception {
        MvcResult mvcResultInvalid1 = mvc.perform(MockMvcRequestBuilders.get("/animals/123")
                .accept(MediaType.APPLICATION_JSON_VALUE)).andReturn();
        int statusInvalid1 = mvcResultInvalid1.getResponse().getStatus();
        assertEquals(200, statusInvalid1);

        MvcResult mvcResultInvalid2 = mvc.perform(MockMvcRequestBuilders.get("/animals")
                .accept(MediaType.APPLICATION_JSON_VALUE)).andReturn();
        int statusInvalid2 = mvcResultInvalid2.getResponse().getStatus();
        assertEquals(404, statusInvalid2);

        MvcResult mvcResultInvalid3 = mvc.perform(MockMvcRequestBuilders.get("/animals/")
                .accept(MediaType.APPLICATION_JSON_VALUE)).andReturn();
        int statusInvalid3 = mvcResultInvalid3.getResponse().getStatus();
        assertEquals(405, statusInvalid3);

        MvcResult mvcResultInvalid4 = mvc.perform(MockMvcRequestBuilders.get("/animals/notanumber")
                .accept(MediaType.APPLICATION_JSON_VALUE)).andReturn();
        ...
        MvcResult mvcResult23 = mvc.perform(MockMvcRequestBuilders.get("/animals/23")
                .accept(MediaType.APPLICATION_JSON_VALUE)).andReturn();
    ...
    @Test
    public void getAnimalsByOriginTest() throws Exception {
        MvcResult mvcResultInvalid1 = mvc.perform(MockMvcRequestBuilders.get("/animals/origin")
                .accept(MediaType.APPLICATION_JSON_VALUE)).andReturn();
        int statusInvalid1 = mvcResultInvalid1.getResponse().getStatus();
        assertEquals(400, statusInvalid1);

        MvcResult mvcResultInvalid2 = mvc.perform(MockMvcRequestBuilders.get("/animals/origin/home")
                .accept(MediaType.APPLICATION_JSON_VALUE)).andReturn();
        int statusInvalid2 = mvcResultInvalid2.getResponse().getStatus();
        ...
        // testing with new existing animal
        MvcResult mvcResultFarm = mvc.perform(MockMvcRequestBuilders.get("/animals/origin/farm")
                .accept(MediaType.APPLICATION_JSON_VALUE)).andReturn();
    ...
    @Test
    public void getAnimalsByDate() throws Exception {
        MvcResult mvcResultInvalid1 = mvc.perform(MockMvcRequestBuilders.get("/animals/date")
                .accept(MediaType.APPLICATION_JSON_VALUE)).andReturn();
        int statusInvalid1 = mvcResultInvalid1.getResponse().getStatus();
        assertEquals(400, statusInvalid1);

        MvcResult mvcResultInvalid2 = mvc.perform(MockMvcRequestBuilders.get("/animals/date/")
                .accept(MediaType.APPLICATION_JSON_VALUE)).andReturn();
        int statusInvalid2 = mvcResultInvalid2.getResponse().getStatus();
        assertEquals(200, statusInvalid2);
        ...
        MvcResult mvcResultInvalid3 = mvc.perform(MockMvcRequestBuilders.get("/animals/date/?day=2222")
                .accept(MediaType.APPLICATION_JSON_VALUE)).andReturn();
        int statusInvalid3 = mvcResultInvalid3.getResponse().getStatus();
        assertEquals(200, statusInvalid3); // provides no list so we dont check it


        MvcResult mvcResultInvalid4 = mvc.perform(MockMvcRequestBuilders.get("/animals/date/?day=1&month=1&year=1950")
                .accept(MediaType.APPLICATION_JSON_VALUE)).andReturn();
        int statusInvalid4 = mvcResultInvalid4.getResponse().getStatus();
        ...
        MvcResult mvcResult1 = mvc.perform(MockMvcRequestBuilders.get("/animals/date/?day=10&month=1&year=2020")
                .accept(MediaType.APPLICATION_JSON_VALUE)).andReturn();
    ...
    public void createAnimalTest() throws Exception {
        ...
        MvcResult mvcResult = mvc.perform(MockMvcRequestBuilders.post("/animals/")
                .contentType(MediaType.APPLICATION_JSON_VALUE).content(inputJson)).andReturn();
        ...
        MvcResult mvcResultInvalid = mvc.perform(MockMvcRequestBuilders.post("/animals/")
                .contentType(MediaType.APPLICATION_JSON_VALUE).content(invalidInputJson)).andReturn();
